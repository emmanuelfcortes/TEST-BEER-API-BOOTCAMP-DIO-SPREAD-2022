...
public class BeerServiceTest {
    ...
    void whenBeerInformedThenShouldBeCreated() throws BeerAlreadyRegisteredException {
        ...
        assertEquals(expectedBeerDTO.getMax(), createdBeerDto.getMax());
    }
    /* TEACHER SOLUTION
    ...
    */
    @Test
    void whenAlreadyCreatedBeerInformedThenShouldReturnAThrown(){
        //given - Objects
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    */
    ...
    void whenDecrementIsCalledThenDecrementBeerStock() throws BeerNotFoundException, BeerStockMinimumException {
        ...
        assertThat(incrementedBeerDTO.getQuantity(), greaterThan(0));
    }

    @Test
    void whenDecrementIsCalledToEmptyStockThenReturnEmptyBeerStock() throws BeerNotFoundException, BeerStockExceededException, BeerStockMinimumException {
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
        ...
        BeerDTO incrementedBeerDTO = beerService.decrement(expectedBeerDTO.getId(), quantityToDecrement);
        //Junit syntax
        assertEquals(expectedQuantityAfterDecrement, 0);
        assertEquals(expectedQuantityAfterDecrement, incrementedBeerDTO.getQuantity());
        //Hamcrest syntax
